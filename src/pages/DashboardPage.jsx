...
import { Badge, EmptyState, PageLoader, ImageLightbox } from '../components/ui'
    ...
    <div data-anim={delay}
      ...
      <div className="flex flex-col gap-2 flex-shrink-0">
        <div className="w-16 h-16 rounded-xl overflow-hidden bg-ink-100 border border-ink-200 shadow-sm relative">
          {item.foto_url
            ? <img src={item.foto_url} alt="foto" className="w-full h-full object-cover cursor-pointer hover:opacity-80 transition-opacity" onClick={() => setSelectedImage(item.foto_url)} />
        ...
        {item.foto_perbaikan_url && (
          <div className="w-16 h-16 rounded-xl overflow-hidden bg-emerald-50 border border-emerald-200 shadow-sm relative">
            <img src={item.foto_perbaikan_url} alt="foto perbaikan" className="w-full h-full object-cover cursor-pointer hover:opacity-80 transition-opacity" onClick={() => setSelectedImage(item.foto_perbaikan_url)} />
