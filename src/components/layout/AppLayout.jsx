          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {[
                  ['Portal FKI', 'https://fki.ums.ac.id'],
                  ['Instagram FKI', 'https://www.instagram.com/fkiums.official?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=='],
                  ['Tiktok', 'https://www.tiktok.com/@fkiums.official?is_from_webapp=1&sender_device=pc'],
